...
class t_ApplyThreshold(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("t_ApplyThreshold")  # TODO: make this more human readable by adding spaces
        # TODO: set categories (folders where the module shows up in the module selector)
        self.parent.categories = [translate("qSlicerAbstractCoreModule", "SL_tutorial")]
...
See more information in <a href="https://github.com/organization/projectname#t_ApplyThreshold">module documentation</a>.
""")
...
class t_ApplyThresholdWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: Optional[t_ApplyThresholdParameterNode]) -> None:
        """
